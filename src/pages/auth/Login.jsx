...
export default function Login() {
  ...
  return (
    <main className="w-full pt-12 min-h-dvh flex justify-center items-center bg-[url(/pawel-czerwinski-xwp0_eLoZp0-unsplash.jpg)] bg-center bg-cover bg-gray-900">
     {loading && (
